...
public class UserDto extends BaseUpdatableDto {
    ...
    @Schema(description = "company sid", required = false, example = "100001")
    private Long companySid;

    @Schema(description = "group sid", required = false, example = "100001")
    private Long groupSid;

    @Schema(description = "group명", required = false, example = "IT 개발본부")
    private String groupName;

    @Schema(description = "비밀번호", required = false, example = "!@#34234!@24")
    private String password;

    @Schema(description = "전화번호", required = false, example = "010-1111-2222")
    private String phone;

    @Schema(description = "유저상태", required = false, example = "active")
    @JsonProperty(access = JsonProperty.Access.READ_ONLY)
    private User.Status status;

    @Schema(description = "권한", required = false, example = "normal")
    @JsonProperty(access = JsonProperty.Access.READ_ONLY)
